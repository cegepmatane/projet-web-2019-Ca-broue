...
$page = (object)
[
    "titre" => "Condition de confidentialité",
    "titrePrincipal" => "Condition de confidentialité",
];
...
function afficherPage($page)
{
	afficherEntete($page);
    ?>
    Le <i>G&eacute;n&eacute;rateur de politique de confidentialit&eacute;</i> est un questionnaire. La politique qui vous est pr&eacute;sent&eacute;e ici tient compte des r&eacute;ponses que vous avez fournies. <u>Cette politique n'est qu'un mod&egrave;le</u>. En effet, le <i>G&eacute;n&eacute;rateur de politique de confidentialit&eacute;</i> <u>n'a pas pour fonction de certifier</u> vos engagements en mati&egrave;re de protection des renseignements personnels. <br />
Par cons&eacute;quent, ni le recours au <i>G&eacute;n&eacute;rateur de politique de confidentialit&eacute;</i>, ni la politique qui est ici pr&eacute;sent&eacute;e <u>ne constituent un avis juridique</u>. En aucun cas, ces outils ne sauraient remplacer une expertise sp&eacute;cifique dans des cas particuliers. Les personnes qui sont confront&eacute;es avec un probl&egrave;me sp&eacute;cifique d'application de la loi sont invit&eacute;es &agrave; consulter un avocat ou un notaire.
<hr>
...
<p>
	...
	Code postal : Avenue St Rédempteur, Matane g4w1l1<br />	Courriel : admins@microcabroue.com<br />		Section du site web : www.microcabroue.com/<br />	</p><hr/>
...
<p>
	...
	Code postal : Avenue St Rédempteur, Matane g4w1l1<br />			Section du site web : www.microcabroue.com/<br />	</p><hr/>
